...
(Season_16 <- as.data.frame(cbind(ID,Name,Age,Nationality,O_Rating,P_Rating,Growth,Club,Value,Wage,Game_Impact,Position,Attack,Defense,Acceleration,Stamina,Positioning,Penalties,GKeeping,Attacking_WR,Defense_WR)))
