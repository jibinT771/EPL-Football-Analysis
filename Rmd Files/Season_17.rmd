...
(Season_17 <- as.data.frame(cbind(ID,Name,Age,Nationality,O_Rating,P_Rating,Growth,Club,Value,Wage,Game_Impact,Position,Attack,Defense,Acceleration,Stamina,Positioning,Penalties,GKeeping,Attacking_WR,Defense_WR)))
...
#The datset for Season 2016 with data scraped for 3000 players is saved as Data Sets/Season_17.csv
